...
class ComposersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create composer" do
    assert_difference('Composer.count') do
      post composers_url, params: { composer: { category_id: @composer.category_id, description: @composer.description, image_src: @composer.image_src, name: @composer.name } }
    end
  ...
  test "should update composer" do
    patch composer_url(@composer), params: { composer: { category_id: @composer.category_id, description: @composer.description, image_src: @composer.image_src, name: @composer.name } }
